                ...
                for video in video_data:
                    try:
                        ...
                        kalodata_data = {
                            ...
                            "category1": video.get("product_pri_cate_id", ""),
                            "category2": video.get("product_sec_cate_id", ""),
                            "category3": video.get("product_ter_cate_id", ""),
            ...
            try:
                ...
                for category3 in all_category3:
                    try:
                        ...
                        try:
                            # 直接将数据字典传递给服务函数
                            logger.info(f"调用fetch_and_store_kalodata_service获取数据，参数: {fetch_data}")
                            result = await fetch_and_store_kalodata_service(fetch_data)
